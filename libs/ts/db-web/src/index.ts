...
if (!process.env.WEB_DATABASE_URL) {
  throw new Error("WEB_DATABASE_URL environment variable is not defined.");
}
...
declare global {
  ...
  var dbWebInternal: Kysely<DB> | undefined;
}

export const dbWeb = global.dbWebInternal || createDbInstance();
