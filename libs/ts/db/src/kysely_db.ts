...
export enum IndexerVariant {
  ...
  ARBITRUM_COUNCIL_MEMBER_PROPOSAL = "ARBITRUM_COUNCIL_MEMBER_PROPOSAL",
  ARBITRUM_COUNCIL_MEMBER_VOTE = "ARBITRUM_COUNCIL_MEMBER_VOTE",
  ARBITRUM_COUNCIL_NOMINATION_PROPOSAL = "ARBITRUM_COUNCIL_NOMINATION_PROPOSAL",
  ARBITRUM_COUNCIL_NOMINATION_VOTE = "ARBITRUM_COUNCIL_NOMINATION_VOTE",
