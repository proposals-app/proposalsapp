...
pub use super::{
    ...
    kysely_migration_lock::Entity as KyselyMigrationLock, proposal::Entity as Proposal,
    proposal_group::Entity as ProposalGroup, subscription::Entity as Subscription,
    user::Entity as User,
