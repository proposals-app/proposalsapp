...
export function BasicEvent({ content, url, last }: BasicEventProps) {
  return (
    <div className='relative my-1 mr-4 flex h-8 w-full items-center'>
      <div
        className='text-neutral-650 flex h-full w-full items-center justify-between rounded-xs
          border border-neutral-300 bg-neutral-100 px-4 py-1 dark:border-neutral-600
