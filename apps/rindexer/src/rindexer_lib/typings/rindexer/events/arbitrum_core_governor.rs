...
use super::arbitrum_core_governor_abi_gen::RindexerArbitrumCoreGovernorGen::{self, RindexerArbitrumCoreGovernorGenEvents, RindexerArbitrumCoreGovernorGenInstance};
...
pub type InitializedData = RindexerArbitrumCoreGovernorGen::Initialized;
...
pub type LateQuorumVoteExtensionSetData = RindexerArbitrumCoreGovernorGen::LateQuorumVoteExtensionSet;
...
pub type OwnershipTransferredData = RindexerArbitrumCoreGovernorGen::OwnershipTransferred;
...
pub type ProposalCanceledData = RindexerArbitrumCoreGovernorGen::ProposalCanceled;
...
pub type ProposalCreatedData = RindexerArbitrumCoreGovernorGen::ProposalCreated;
...
pub type ProposalExecutedData = RindexerArbitrumCoreGovernorGen::ProposalExecuted;
...
pub type ProposalExtendedData = RindexerArbitrumCoreGovernorGen::ProposalExtended;
...
pub type ProposalQueuedData = RindexerArbitrumCoreGovernorGen::ProposalQueued;
...
pub type ProposalThresholdSetData = RindexerArbitrumCoreGovernorGen::ProposalThresholdSet;
...
pub type QuorumNumeratorUpdatedData = RindexerArbitrumCoreGovernorGen::QuorumNumeratorUpdated;
...
pub type TimelockChangeData = RindexerArbitrumCoreGovernorGen::TimelockChange;
...
pub type VoteCastData = RindexerArbitrumCoreGovernorGen::VoteCast;
...
pub type VoteCastWithParamsData = RindexerArbitrumCoreGovernorGen::VoteCastWithParams;
...
pub type VotingDelaySetData = RindexerArbitrumCoreGovernorGen::VotingDelaySet;
...
pub type VotingPeriodSetData = RindexerArbitrumCoreGovernorGen::VotingPeriodSet;
...
pub async fn arbitrum_core_governor_contract(network: &str) -> RindexerArbitrumCoreGovernorGenInstance<Arc<RindexerProvider>> {
...
pub async fn decoder_contract(network: &str) -> RindexerArbitrumCoreGovernorGenInstance<Arc<RindexerProvider>> {
    if network == "arbitrum" {
        RindexerArbitrumCoreGovernorGen::new(
    ...
    fn decoder(&self, network: &str) -> Arc<dyn Fn(Vec<B256>, Bytes) -> Arc<dyn Any + Send + Sync> + Send + Sync> {
        ...
        match self {
            ArbitrumCoreGovernorEventType::ProposalCreated(_) => Arc::new(
                move |topics: Vec<B256>, data: Bytes| match ProposalCreatedData::decode_raw_log(topics, &data[0..]) {
                    Ok(event) => {
            ...
            ArbitrumCoreGovernorEventType::ProposalExecuted(_) => Arc::new(
                move |topics: Vec<B256>, data: Bytes| match ProposalExecutedData::decode_raw_log(topics, &data[0..]) {
                    Ok(event) => {
            ...
            ArbitrumCoreGovernorEventType::ProposalExtended(_) => Arc::new(
                move |topics: Vec<B256>, data: Bytes| match ProposalExtendedData::decode_raw_log(topics, &data[0..]) {
                    Ok(event) => {
            ...
            ArbitrumCoreGovernorEventType::VoteCast(_) => Arc::new(
                move |topics: Vec<B256>, data: Bytes| match VoteCastData::decode_raw_log(topics, &data[0..]) {
                    Ok(event) => {
