...
use super::arbitrum_core_governor_abi_gen::rindexer_arbitrum_core_governor_gen::{
    self, RindexerArbitrumCoreGovernorGen,
};
use ethers::{
    abi::Address,
...
pub type LateQuorumVoteExtensionSetData =
    rindexer_arbitrum_core_governor_gen::LateQuorumVoteExtensionSetFilter;
...
pub type QuorumNumeratorUpdatedData =
    rindexer_arbitrum_core_governor_gen::QuorumNumeratorUpdatedFilter;
...
pub fn initialized_handler<TExtensions, F, Fut>(
    custom_logic: F,
) -> InitializedEventCallbackType<TExtensions>
where
    InitializedResult: Clone + 'static,
    F: for<'a> Fn(Vec<InitializedResult>, Arc<EventContext<TExtensions>>) -> Fut
        + Send
        + Sync
        + 'static
        + Clone,
...
type InitializedEventCallbackType<TExtensions> = Arc<
    dyn for<'a> Fn(
            &'a Vec<InitializedResult>,
    ...
    TExtensions: Send + Sync,
{
    async fn call(&self, events: Vec<EventResult>) -> EventCallbackResult<()> {
        ...
        let result: Vec<InitializedResult> = events
            ...
            .filter_map(|item| {
                item.decoded_data
                    .downcast::<InitializedData>()
                    .ok()
                    .map(|arc| InitializedResult {
...
pub fn latequorumvoteextensionset_handler<TExtensions, F, Fut>(
    custom_logic: F,
) -> LateQuorumVoteExtensionSetEventCallbackType<TExtensions>
where
    LateQuorumVoteExtensionSetResult: Clone + 'static,
    F: for<'a> Fn(Vec<LateQuorumVoteExtensionSetResult>, Arc<EventContext<TExtensions>>) -> Fut
        + Send
        + Sync
        + 'static
        + Clone,
...
type LateQuorumVoteExtensionSetEventCallbackType<TExtensions> = Arc<
    dyn for<'a> Fn(
            &'a Vec<LateQuorumVoteExtensionSetResult>,
            Arc<EventContext<TExtensions>>,
        ) -> BoxFuture<'a, EventCallbackResult<()>>
        + Send
        + Sync,
    ...
    TExtensions: Send + Sync,
{
    async fn call(&self, events: Vec<EventResult>) -> EventCallbackResult<()> {
        ...
        if result.len() == events_len {
            ...
            panic!("LateQuorumVoteExtensionSetEvent: Unexpected data type - expected: LateQuorumVoteExtensionSetData")
        }
    }
}

pub fn ownershiptransferred_handler<TExtensions, F, Fut>(
    custom_logic: F,
) -> OwnershipTransferredEventCallbackType<TExtensions>
where
    OwnershipTransferredResult: Clone + 'static,
    F: for<'a> Fn(Vec<OwnershipTransferredResult>, Arc<EventContext<TExtensions>>) -> Fut
        + Send
        + Sync
        + 'static
        + Clone,
...
type OwnershipTransferredEventCallbackType<TExtensions> = Arc<
    dyn for<'a> Fn(
            &'a Vec<OwnershipTransferredResult>,
            Arc<EventContext<TExtensions>>,
        ) -> BoxFuture<'a, EventCallbackResult<()>>
        + Send
        + Sync,
    ...
    TExtensions: Send + Sync,
{
    async fn call(&self, events: Vec<EventResult>) -> EventCallbackResult<()> {
        ...
        if result.len() == events_len {
            ...
            panic!("OwnershipTransferredEvent: Unexpected data type - expected: OwnershipTransferredData")
        }
    }
}

pub fn proposalcanceled_handler<TExtensions, F, Fut>(
    custom_logic: F,
) -> ProposalCanceledEventCallbackType<TExtensions>
where
    ProposalCanceledResult: Clone + 'static,
    F: for<'a> Fn(Vec<ProposalCanceledResult>, Arc<EventContext<TExtensions>>) -> Fut
        + Send
        + Sync
        + 'static
        + Clone,
...
pub fn proposalqueued_handler<TExtensions, F, Fut>(
    custom_logic: F,
) -> ProposalQueuedEventCallbackType<TExtensions>
where
    ProposalQueuedResult: Clone + 'static,
    F: for<'a> Fn(Vec<ProposalQueuedResult>, Arc<EventContext<TExtensions>>) -> Fut
        + Send
        + Sync
        + 'static
        + Clone,
...
pub fn proposalthresholdset_handler<TExtensions, F, Fut>(
    custom_logic: F,
) -> ProposalThresholdSetEventCallbackType<TExtensions>
where
    ProposalThresholdSetResult: Clone + 'static,
    F: for<'a> Fn(Vec<ProposalThresholdSetResult>, Arc<EventContext<TExtensions>>) -> Fut
        + Send
        + Sync
        + 'static
        + Clone,
...
type ProposalThresholdSetEventCallbackType<TExtensions> = Arc<
    dyn for<'a> Fn(
            &'a Vec<ProposalThresholdSetResult>,
            Arc<EventContext<TExtensions>>,
        ) -> BoxFuture<'a, EventCallbackResult<()>>
        + Send
        + Sync,
    ...
    TExtensions: Send + Sync,
{
    async fn call(&self, events: Vec<EventResult>) -> EventCallbackResult<()> {
        ...
        if result.len() == events_len {
            ...
            panic!("ProposalThresholdSetEvent: Unexpected data type - expected: ProposalThresholdSetData")
        }
    }
}

pub fn quorumnumeratorupdated_handler<TExtensions, F, Fut>(
    custom_logic: F,
) -> QuorumNumeratorUpdatedEventCallbackType<TExtensions>
where
    QuorumNumeratorUpdatedResult: Clone + 'static,
    F: for<'a> Fn(Vec<QuorumNumeratorUpdatedResult>, Arc<EventContext<TExtensions>>) -> Fut
        + Send
        + Sync
        + 'static
        + Clone,
...
type QuorumNumeratorUpdatedEventCallbackType<TExtensions> = Arc<
    dyn for<'a> Fn(
            &'a Vec<QuorumNumeratorUpdatedResult>,
            Arc<EventContext<TExtensions>>,
        ) -> BoxFuture<'a, EventCallbackResult<()>>
        + Send
        + Sync,
    ...
    TExtensions: Send + Sync,
{
    async fn call(&self, events: Vec<EventResult>) -> EventCallbackResult<()> {
        ...
        if result.len() == events_len {
            ...
            panic!("QuorumNumeratorUpdatedEvent: Unexpected data type - expected: QuorumNumeratorUpdatedData")
        }
    }
}

pub fn timelockchange_handler<TExtensions, F, Fut>(
    custom_logic: F,
) -> TimelockChangeEventCallbackType<TExtensions>
where
    TimelockChangeResult: Clone + 'static,
    F: for<'a> Fn(Vec<TimelockChangeResult>, Arc<EventContext<TExtensions>>) -> Fut
        + Send
        + Sync
        + 'static
        + Clone,
...
pub fn votingdelayset_handler<TExtensions, F, Fut>(
    custom_logic: F,
) -> VotingDelaySetEventCallbackType<TExtensions>
where
    VotingDelaySetResult: Clone + 'static,
    F: for<'a> Fn(Vec<VotingDelaySetResult>, Arc<EventContext<TExtensions>>) -> Fut
        + Send
        + Sync
        + 'static
        + Clone,
...
pub fn votingperiodset_handler<TExtensions, F, Fut>(
    custom_logic: F,
) -> VotingPeriodSetEventCallbackType<TExtensions>
where
    VotingPeriodSetResult: Clone + 'static,
    F: for<'a> Fn(Vec<VotingPeriodSetResult>, Arc<EventContext<TExtensions>>) -> Fut
        + Send
        + Sync
        + 'static
        + Clone,
...
pub fn arbitrum_core_governor_contract(
    network: &str,
) -> RindexerArbitrumCoreGovernorGen<Arc<Provider<RetryClient<Http>>>> {
    ...
    TExtensions: 'static + Send + Sync,
{
    pub fn topic_id(&self) -> &'static str {
        match self {
            ArbitrumCoreGovernorEventType::Initialized(_) => {
            ...
            ArbitrumCoreGovernorEventType::OwnershipTransferred(_) => {
                "0x8be0079c531659141344cd1fd0a4f28419497f9722a3daafe3b4186f6b6457e0"
            }
            ArbitrumCoreGovernorEventType::ProposalCanceled(_) => {
                "0x789cf55be980739dad1d0699b93b58e806b51c9d96619bfa8fe0a28abaa7b30c"
            }
            ArbitrumCoreGovernorEventType::ProposalCreated(_) => {
                "0x7d84a6263ae0d98d3329bd7b46bb4e8d6f98cd35a7adb45c274c8b7fd5ebd5e0"
            }
            ArbitrumCoreGovernorEventType::ProposalExecuted(_) => {
                "0x712ae1383f79ac853f8d882153778e0260ef8f03b504e2866e0593e04d2b291f"
            }
            ArbitrumCoreGovernorEventType::ProposalExtended(_) => {
                "0x541f725fb9f7c98a30cc9c0ff32fbb14358cd7159c847a3aa20a2bdc442ba511"
            }
            ArbitrumCoreGovernorEventType::ProposalQueued(_) => {
                "0x9a2e42fd6722813d69113e7d0079d3d940171428df7373df9c7f7617cfda2892"
            }
            ArbitrumCoreGovernorEventType::ProposalThresholdSet(_) => {
    ...
    fn decoder(
        ...
        match self {
            ...
            ArbitrumCoreGovernorEventType::ProposalCreated(_) => Arc::new(
                move |topics: Vec<H256>, data: Bytes| match ProposalCreatedData::decode_log(
                    &ethers::core::abi::RawLog {
                        topics,
                        data: data.to_vec(),
                    },
                ) {
            ...
            ArbitrumCoreGovernorEventType::ProposalQueued(_) => Arc::new(
                move |topics: Vec<H256>, data: Bytes| match ProposalQueuedData::decode_log(
                    &ethers::core::abi::RawLog {
                        topics,
                        data: data.to_vec(),
                    },
            ...
            ArbitrumCoreGovernorEventType::TimelockChange(_) => Arc::new(
                move |topics: Vec<H256>, data: Bytes| match TimelockChangeData::decode_log(
                    &ethers::core::abi::RawLog {
                        topics,
                        data: data.to_vec(),
                    },
            ...
            ArbitrumCoreGovernorEventType::VotingDelaySet(_) => Arc::new(
                move |topics: Vec<H256>, data: Bytes| match VotingDelaySetData::decode_log(
                    &ethers::core::abi::RawLog {
                        topics,
                        data: data.to_vec(),
                    },
            ...
            ArbitrumCoreGovernorEventType::VotingPeriodSet(_) => Arc::new(
                move |topics: Vec<H256>, data: Bytes| match VotingPeriodSetData::decode_log(
                    &ethers::core::abi::RawLog {
                        topics,
                        data: data.to_vec(),
                    },
