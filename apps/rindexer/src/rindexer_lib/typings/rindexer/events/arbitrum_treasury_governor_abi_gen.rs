...
pub mod rindexer_arbitrum_treasury_governor_gen {
    ...
    pub static RINDEXERARBITRUMTREASURYGOVERNORGEN_ABI: ::ethers::contract::Lazy<
        ::ethers::core::abi::Abi,
    ...
    impl<M: ::ethers::providers::Middleware> RindexerArbitrumTreasuryGovernorGen<M> {
        ...
        pub fn events(
            ...
            ::std::sync::Arc<M>,
            M,
            RindexerArbitrumTreasuryGovernorGenEvents,
        > {
            self.0
    ...
    impl<M: ::ethers::providers::Middleware> From<::ethers::contract::Contract<M>>
        for RindexerArbitrumTreasuryGovernorGen<M>
    {
    ...
    impl ::ethers::contract::EthLogDecode for RindexerArbitrumTreasuryGovernorGenEvents {
        fn decode_log(
            ...
            if let Ok(decoded) = LateQuorumVoteExtensionSetFilter::decode_log(log) {
                return Ok(
                    RindexerArbitrumTreasuryGovernorGenEvents::LateQuorumVoteExtensionSetFilter(
                        decoded,
                    ),
                );
            }
            if let Ok(decoded) = OwnershipTransferredFilter::decode_log(log) {
                return Ok(
                    RindexerArbitrumTreasuryGovernorGenEvents::OwnershipTransferredFilter(decoded),
                );
            }
            if let Ok(decoded) = ProposalCanceledFilter::decode_log(log) {
                return Ok(
                    RindexerArbitrumTreasuryGovernorGenEvents::ProposalCanceledFilter(decoded),
                );
            }
            if let Ok(decoded) = ProposalCreatedFilter::decode_log(log) {
                return Ok(
                    RindexerArbitrumTreasuryGovernorGenEvents::ProposalCreatedFilter(decoded),
                );
            }
            if let Ok(decoded) = ProposalExecutedFilter::decode_log(log) {
                return Ok(
                    RindexerArbitrumTreasuryGovernorGenEvents::ProposalExecutedFilter(decoded),
                );
            }
            if let Ok(decoded) = ProposalExtendedFilter::decode_log(log) {
                return Ok(
                    RindexerArbitrumTreasuryGovernorGenEvents::ProposalExtendedFilter(decoded),
                );
            }
            if let Ok(decoded) = ProposalQueuedFilter::decode_log(log) {
                return Ok(
                    RindexerArbitrumTreasuryGovernorGenEvents::ProposalQueuedFilter(decoded),
                );
            }
            if let Ok(decoded) = ProposalThresholdSetFilter::decode_log(log) {
                return Ok(
                    RindexerArbitrumTreasuryGovernorGenEvents::ProposalThresholdSetFilter(decoded),
                );
            }
            if let Ok(decoded) = QuorumNumeratorUpdatedFilter::decode_log(log) {
                return Ok(
                    RindexerArbitrumTreasuryGovernorGenEvents::QuorumNumeratorUpdatedFilter(
                        decoded,
                    ),
                );
            }
            if let Ok(decoded) = TimelockChangeFilter::decode_log(log) {
                return Ok(
                    RindexerArbitrumTreasuryGovernorGenEvents::TimelockChangeFilter(decoded),
                );
            }
            ...
            if let Ok(decoded) = VoteCastWithParamsFilter::decode_log(log) {
                return Ok(
                    RindexerArbitrumTreasuryGovernorGenEvents::VoteCastWithParamsFilter(decoded),
                );
            }
            if let Ok(decoded) = VotingDelaySetFilter::decode_log(log) {
                return Ok(
                    RindexerArbitrumTreasuryGovernorGenEvents::VotingDelaySetFilter(decoded),
                );
            }
            if let Ok(decoded) = VotingPeriodSetFilter::decode_log(log) {
                return Ok(
                    RindexerArbitrumTreasuryGovernorGenEvents::VotingPeriodSetFilter(decoded),
                );
            }
    ...
    impl ::core::convert::From<LateQuorumVoteExtensionSetFilter>
        for RindexerArbitrumTreasuryGovernorGenEvents
    {
    ...
    impl ::core::convert::From<ExtendedBallotTypehashCall>
        for RindexerArbitrumTreasuryGovernorGenCalls
    {
    ...
    impl ::core::convert::From<GetPastCirculatingSupplyCall>
        for RindexerArbitrumTreasuryGovernorGenCalls
    {
    ...
    impl ::core::convert::From<LateQuorumVoteExtensionCall>
        for RindexerArbitrumTreasuryGovernorGenCalls
    {
