...
use super::uni_token_abi_gen::RindexerUNITokenGen::{
    self, RindexerUNITokenGenEvents, RindexerUNITokenGenInstance,
};
...
pub type ApprovalData = RindexerUNITokenGen::Approval;
...
pub enum UNITokenEventType<TExtensions>
where
...
pub async fn uni_token_contract(
    network: &str,
) -> RindexerUNITokenGenInstance<Arc<RindexerProvider>> {
    let address: Address = "0x1f9840a85d5af5bf1d1762f925bdaddc4201f984"
        .parse()
        .expect("Invalid address");
    RindexerUNITokenGen::new(
        address,
...
pub async fn decoder_contract(network: &str) -> RindexerUNITokenGenInstance<Arc<RindexerProvider>> {
    if network == "ethereum" {
        RindexerUNITokenGen::new(
...
impl<TExtensions> UNITokenEventType<TExtensions>
where
    TExtensions: 'static + Send + Sync,
{
    pub fn topic_id(&self) -> &'static str {
        match self {
            UNITokenEventType::DelegateChanged(_) => {
                "0x3134e8a2e6d97e929a7e54011ea5485d7d196dd5f0ba4d4ef95803e8e3fc257f"
            }
            UNITokenEventType::DelegateVotesChanged(_) => {
    ...
    pub fn event_name(&self) -> &'static str {
        match self {
            UNITokenEventType::DelegateChanged(_) => "DelegateChanged",
            UNITokenEventType::DelegateVotesChanged(_) => "DelegateVotesChanged",
        }
    }
