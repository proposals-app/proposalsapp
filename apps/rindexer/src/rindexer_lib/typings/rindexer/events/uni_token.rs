...
use super::uni_token_abi_gen::RindexerUNITokenGen::{self, RindexerUNITokenGenEvents, RindexerUNITokenGenInstance};
...
pub async fn uni_token_contract(network: &str) -> RindexerUNITokenGenInstance<Arc<RindexerProvider>> {
    ...
    TExtensions: 'static + Send + Sync,
{
    pub fn topic_id(&self) -> &'static str {
        match self {
            UNITokenEventType::DelegateChanged(_) => "0x3134e8a2e6d97e929a7e54011ea5485d7d196dd5f0ba4d4ef95803e8e3fc257f",
            UNITokenEventType::DelegateVotesChanged(_) => "0xdec2bacdd2f05b59de34da9b523dff8be42e5e38e818c82fdb0bae774387a724",
        }
    }
    ...
    fn decoder(&self, network: &str) -> Arc<dyn Fn(Vec<B256>, Bytes) -> Arc<dyn Any + Send + Sync> + Send + Sync> {
        ...
        match self {
            UNITokenEventType::DelegateChanged(_) => Arc::new(
            ...
            UNITokenEventType::DelegateVotesChanged(_) => Arc::new(
