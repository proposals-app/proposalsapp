pub use rindexer_arbitrum_core_governor_gen::*;
...
pub mod rindexer_arbitrum_core_governor_gen {
    #[allow(deprecated)]
    ...
    pub static RINDEXERARBITRUMCOREGOVERNORGEN_ABI: ::ethers::contract::Lazy<::ethers::core::abi::Abi> =
        ::ethers::contract::Lazy::new(__abi);
    pub struct RindexerArbitrumCoreGovernorGen<M>(::ethers::contract::Contract<M>);
    impl<M> ::core::clone::Clone for RindexerArbitrumCoreGovernorGen<M> {
        fn clone(&self) -> Self {
            Self(::core::clone::Clone::clone(&self.0))
        }
    }
    impl<M> ::core::ops::Deref for RindexerArbitrumCoreGovernorGen<M> {
        type Target = ::ethers::contract::Contract<M>;
        fn deref(&self) -> &Self::Target {
            &self.0
        }
    }
    impl<M> ::core::ops::DerefMut for RindexerArbitrumCoreGovernorGen<M> {
        fn deref_mut(&mut self) -> &mut Self::Target {
            &mut self.0
        }
    }
    impl<M> ::core::fmt::Debug for RindexerArbitrumCoreGovernorGen<M> {
        fn fmt(&self, f: &mut ::core::fmt::Formatter<'_>) -> ::core::fmt::Result {
            f.debug_tuple(::core::stringify!(RindexerArbitrumCoreGovernorGen))
                .field(&self.address())
                .finish()
        }
    }
    impl<M: ::ethers::providers::Middleware> RindexerArbitrumCoreGovernorGen<M> {
        ...
        pub fn new<T: Into<::ethers::core::types::Address>>(address: T, client: ::std::sync::Arc<M>) -> Self {
            Self(::ethers::contract::Contract::new(
                address.into(),
                RINDEXERARBITRUMCOREGOVERNORGEN_ABI.clone(),
                client,
            ))
        }
        ...
        pub fn events(&self) -> ::ethers::contract::builders::Event<::std::sync::Arc<M>, M, RindexerArbitrumCoreGovernorGenEvents> {
            self.0.event_with_filter(::core::default::Default::default())
        }
    }
    impl<M: ::ethers::providers::Middleware> From<::ethers::contract::Contract<M>> for RindexerArbitrumCoreGovernorGen<M> {
    ...
    pub enum RindexerArbitrumCoreGovernorGenEvents {
    ...
    impl ::ethers::contract::EthLogDecode for RindexerArbitrumCoreGovernorGenEvents {
        fn decode_log(log: &::ethers::core::abi::RawLog) -> ::core::result::Result<Self, ::ethers::core::abi::Error> {
            if let Ok(decoded) = InitializedFilter::decode_log(log) {
                return Ok(RindexerArbitrumCoreGovernorGenEvents::InitializedFilter(decoded));
            }
            if let Ok(decoded) = LateQuorumVoteExtensionSetFilter::decode_log(log) {
                return Ok(RindexerArbitrumCoreGovernorGenEvents::LateQuorumVoteExtensionSetFilter(decoded));
            }
            if let Ok(decoded) = OwnershipTransferredFilter::decode_log(log) {
                return Ok(RindexerArbitrumCoreGovernorGenEvents::OwnershipTransferredFilter(decoded));
            }
            if let Ok(decoded) = ProposalCanceledFilter::decode_log(log) {
                return Ok(RindexerArbitrumCoreGovernorGenEvents::ProposalCanceledFilter(decoded));
            }
            if let Ok(decoded) = ProposalCreatedFilter::decode_log(log) {
                return Ok(RindexerArbitrumCoreGovernorGenEvents::ProposalCreatedFilter(decoded));
            }
            if let Ok(decoded) = ProposalExecutedFilter::decode_log(log) {
                return Ok(RindexerArbitrumCoreGovernorGenEvents::ProposalExecutedFilter(decoded));
            }
            if let Ok(decoded) = ProposalExtendedFilter::decode_log(log) {
                return Ok(RindexerArbitrumCoreGovernorGenEvents::ProposalExtendedFilter(decoded));
            }
            if let Ok(decoded) = ProposalQueuedFilter::decode_log(log) {
                return Ok(RindexerArbitrumCoreGovernorGenEvents::ProposalQueuedFilter(decoded));
            }
            if let Ok(decoded) = ProposalThresholdSetFilter::decode_log(log) {
                return Ok(RindexerArbitrumCoreGovernorGenEvents::ProposalThresholdSetFilter(decoded));
            }
            if let Ok(decoded) = QuorumNumeratorUpdatedFilter::decode_log(log) {
                return Ok(RindexerArbitrumCoreGovernorGenEvents::QuorumNumeratorUpdatedFilter(decoded));
            }
            if let Ok(decoded) = TimelockChangeFilter::decode_log(log) {
                return Ok(RindexerArbitrumCoreGovernorGenEvents::TimelockChangeFilter(decoded));
            }
            if let Ok(decoded) = VoteCastFilter::decode_log(log) {
                return Ok(RindexerArbitrumCoreGovernorGenEvents::VoteCastFilter(decoded));
            }
            if let Ok(decoded) = VoteCastWithParamsFilter::decode_log(log) {
                return Ok(RindexerArbitrumCoreGovernorGenEvents::VoteCastWithParamsFilter(decoded));
            }
            if let Ok(decoded) = VotingDelaySetFilter::decode_log(log) {
                return Ok(RindexerArbitrumCoreGovernorGenEvents::VotingDelaySetFilter(decoded));
            }
            if let Ok(decoded) = VotingPeriodSetFilter::decode_log(log) {
                return Ok(RindexerArbitrumCoreGovernorGenEvents::VotingPeriodSetFilter(decoded));
            }
            Err(::ethers::core::abi::Error::InvalidData)
        }
    }
    impl ::core::fmt::Display for RindexerArbitrumCoreGovernorGenEvents {
        fn fmt(&self, f: &mut ::core::fmt::Formatter<'_>) -> ::core::fmt::Result {
            match self {
    ...
    impl ::core::convert::From<InitializedFilter> for RindexerArbitrumCoreGovernorGenEvents {
        fn from(value: InitializedFilter) -> Self {
            Self::InitializedFilter(value)
        }
    }
    impl ::core::convert::From<LateQuorumVoteExtensionSetFilter> for RindexerArbitrumCoreGovernorGenEvents {
        fn from(value: LateQuorumVoteExtensionSetFilter) -> Self {
            Self::LateQuorumVoteExtensionSetFilter(value)
        }
    }
    impl ::core::convert::From<OwnershipTransferredFilter> for RindexerArbitrumCoreGovernorGenEvents {
        fn from(value: OwnershipTransferredFilter) -> Self {
            Self::OwnershipTransferredFilter(value)
        }
    }
    impl ::core::convert::From<ProposalCanceledFilter> for RindexerArbitrumCoreGovernorGenEvents {
        fn from(value: ProposalCanceledFilter) -> Self {
            Self::ProposalCanceledFilter(value)
        }
    }
    impl ::core::convert::From<ProposalCreatedFilter> for RindexerArbitrumCoreGovernorGenEvents {
        fn from(value: ProposalCreatedFilter) -> Self {
            Self::ProposalCreatedFilter(value)
        }
    }
    impl ::core::convert::From<ProposalExecutedFilter> for RindexerArbitrumCoreGovernorGenEvents {
        fn from(value: ProposalExecutedFilter) -> Self {
            Self::ProposalExecutedFilter(value)
        }
    }
    impl ::core::convert::From<ProposalExtendedFilter> for RindexerArbitrumCoreGovernorGenEvents {
        fn from(value: ProposalExtendedFilter) -> Self {
            Self::ProposalExtendedFilter(value)
        }
    }
    impl ::core::convert::From<ProposalQueuedFilter> for RindexerArbitrumCoreGovernorGenEvents {
        fn from(value: ProposalQueuedFilter) -> Self {
            Self::ProposalQueuedFilter(value)
        }
    }
    impl ::core::convert::From<ProposalThresholdSetFilter> for RindexerArbitrumCoreGovernorGenEvents {
        fn from(value: ProposalThresholdSetFilter) -> Self {
            Self::ProposalThresholdSetFilter(value)
        }
    }
    impl ::core::convert::From<QuorumNumeratorUpdatedFilter> for RindexerArbitrumCoreGovernorGenEvents {
        fn from(value: QuorumNumeratorUpdatedFilter) -> Self {
            Self::QuorumNumeratorUpdatedFilter(value)
        }
    }
    impl ::core::convert::From<TimelockChangeFilter> for RindexerArbitrumCoreGovernorGenEvents {
        fn from(value: TimelockChangeFilter) -> Self {
            Self::TimelockChangeFilter(value)
        }
    }
    impl ::core::convert::From<VoteCastFilter> for RindexerArbitrumCoreGovernorGenEvents {
        fn from(value: VoteCastFilter) -> Self {
            Self::VoteCastFilter(value)
        }
    }
    impl ::core::convert::From<VoteCastWithParamsFilter> for RindexerArbitrumCoreGovernorGenEvents {
        fn from(value: VoteCastWithParamsFilter) -> Self {
            Self::VoteCastWithParamsFilter(value)
        }
    }
    impl ::core::convert::From<VotingDelaySetFilter> for RindexerArbitrumCoreGovernorGenEvents {
        fn from(value: VotingDelaySetFilter) -> Self {
            Self::VotingDelaySetFilter(value)
        }
    }
    impl ::core::convert::From<VotingPeriodSetFilter> for RindexerArbitrumCoreGovernorGenEvents {
    ...
    #[derive(Clone, ::ethers::contract::EthAbiType, Debug, PartialEq, Eq, Hash)]
    pub enum RindexerArbitrumCoreGovernorGenCalls {
    ...
    impl ::ethers::core::abi::AbiDecode for RindexerArbitrumCoreGovernorGenCalls {
    ...
    impl ::ethers::core::abi::AbiEncode for RindexerArbitrumCoreGovernorGenCalls {
    ...
    impl ::core::fmt::Display for RindexerArbitrumCoreGovernorGenCalls {
        fn fmt(&self, f: &mut ::core::fmt::Formatter<'_>) -> ::core::fmt::Result {
            match self {
    ...
    impl ::core::convert::From<BallotTypehashCall> for RindexerArbitrumCoreGovernorGenCalls {
        fn from(value: BallotTypehashCall) -> Self {
            Self::BallotTypehash(value)
        }
    }
    impl ::core::convert::From<CountingModeCall> for RindexerArbitrumCoreGovernorGenCalls {
        fn from(value: CountingModeCall) -> Self {
            Self::CountingMode(value)
        }
    }
    impl ::core::convert::From<ExcludeAddressCall> for RindexerArbitrumCoreGovernorGenCalls {
        fn from(value: ExcludeAddressCall) -> Self {
            Self::ExcludeAddress(value)
        }
    }
    impl ::core::convert::From<ExtendedBallotTypehashCall> for RindexerArbitrumCoreGovernorGenCalls {
        fn from(value: ExtendedBallotTypehashCall) -> Self {
            Self::ExtendedBallotTypehash(value)
        }
    }
    impl ::core::convert::From<CastVoteCall> for RindexerArbitrumCoreGovernorGenCalls {
        fn from(value: CastVoteCall) -> Self {
            Self::CastVote(value)
        }
    }
    impl ::core::convert::From<CastVoteBySigCall> for RindexerArbitrumCoreGovernorGenCalls {
        fn from(value: CastVoteBySigCall) -> Self {
            Self::CastVoteBySig(value)
        }
    }
    impl ::core::convert::From<CastVoteWithReasonCall> for RindexerArbitrumCoreGovernorGenCalls {
        fn from(value: CastVoteWithReasonCall) -> Self {
            Self::CastVoteWithReason(value)
        }
    }
    impl ::core::convert::From<CastVoteWithReasonAndParamsCall> for RindexerArbitrumCoreGovernorGenCalls {
        fn from(value: CastVoteWithReasonAndParamsCall) -> Self {
            Self::CastVoteWithReasonAndParams(value)
        }
    }
    impl ::core::convert::From<CastVoteWithReasonAndParamsBySigCall> for RindexerArbitrumCoreGovernorGenCalls {
        fn from(value: CastVoteWithReasonAndParamsBySigCall) -> Self {
            Self::CastVoteWithReasonAndParamsBySig(value)
        }
    }
    impl ::core::convert::From<ExecuteCall> for RindexerArbitrumCoreGovernorGenCalls {
        fn from(value: ExecuteCall) -> Self {
            Self::Execute(value)
        }
    }
    impl ::core::convert::From<GetPastCirculatingSupplyCall> for RindexerArbitrumCoreGovernorGenCalls {
        fn from(value: GetPastCirculatingSupplyCall) -> Self {
            Self::GetPastCirculatingSupply(value)
        }
    }
    impl ::core::convert::From<GetVotesCall> for RindexerArbitrumCoreGovernorGenCalls {
        fn from(value: GetVotesCall) -> Self {
            Self::GetVotes(value)
        }
    }
    impl ::core::convert::From<GetVotesWithParamsCall> for RindexerArbitrumCoreGovernorGenCalls {
        fn from(value: GetVotesWithParamsCall) -> Self {
            Self::GetVotesWithParams(value)
        }
    }
    impl ::core::convert::From<HasVotedCall> for RindexerArbitrumCoreGovernorGenCalls {
        fn from(value: HasVotedCall) -> Self {
            Self::HasVoted(value)
        }
    }
    impl ::core::convert::From<HashProposalCall> for RindexerArbitrumCoreGovernorGenCalls {
        fn from(value: HashProposalCall) -> Self {
            Self::HashProposal(value)
        }
    }
    impl ::core::convert::From<InitializeCall> for RindexerArbitrumCoreGovernorGenCalls {
        fn from(value: InitializeCall) -> Self {
            Self::Initialize(value)
        }
    }
    impl ::core::convert::From<LateQuorumVoteExtensionCall> for RindexerArbitrumCoreGovernorGenCalls {
        fn from(value: LateQuorumVoteExtensionCall) -> Self {
            Self::LateQuorumVoteExtension(value)
        }
    }
    impl ::core::convert::From<NameCall> for RindexerArbitrumCoreGovernorGenCalls {
        fn from(value: NameCall) -> Self {
            Self::Name(value)
        }
    }
    impl ::core::convert::From<OnERC1155BatchReceivedCall> for RindexerArbitrumCoreGovernorGenCalls {
        fn from(value: OnERC1155BatchReceivedCall) -> Self {
            Self::OnERC1155BatchReceived(value)
        }
    }
    impl ::core::convert::From<OnERC1155ReceivedCall> for RindexerArbitrumCoreGovernorGenCalls {
        fn from(value: OnERC1155ReceivedCall) -> Self {
            Self::OnERC1155Received(value)
        }
    }
    impl ::core::convert::From<OnERC721ReceivedCall> for RindexerArbitrumCoreGovernorGenCalls {
        fn from(value: OnERC721ReceivedCall) -> Self {
            Self::OnERC721Received(value)
        }
    }
    impl ::core::convert::From<OwnerCall> for RindexerArbitrumCoreGovernorGenCalls {
        fn from(value: OwnerCall) -> Self {
            Self::Owner(value)
        }
    }
    impl ::core::convert::From<ProposalDeadlineCall> for RindexerArbitrumCoreGovernorGenCalls {
        fn from(value: ProposalDeadlineCall) -> Self {
            Self::ProposalDeadline(value)
        }
    }
    impl ::core::convert::From<ProposalEtaCall> for RindexerArbitrumCoreGovernorGenCalls {
        fn from(value: ProposalEtaCall) -> Self {
            Self::ProposalEta(value)
        }
    }
    impl ::core::convert::From<ProposalSnapshotCall> for RindexerArbitrumCoreGovernorGenCalls {
        fn from(value: ProposalSnapshotCall) -> Self {
            Self::ProposalSnapshot(value)
        }
    }
    impl ::core::convert::From<ProposalThresholdCall> for RindexerArbitrumCoreGovernorGenCalls {
        fn from(value: ProposalThresholdCall) -> Self {
            Self::ProposalThreshold(value)
        }
    }
    impl ::core::convert::From<ProposalVotesCall> for RindexerArbitrumCoreGovernorGenCalls {
        fn from(value: ProposalVotesCall) -> Self {
            Self::ProposalVotes(value)
        }
    }
    impl ::core::convert::From<ProposeCall> for RindexerArbitrumCoreGovernorGenCalls {
        fn from(value: ProposeCall) -> Self {
            Self::Propose(value)
        }
    }
    impl ::core::convert::From<QueueCall> for RindexerArbitrumCoreGovernorGenCalls {
        fn from(value: QueueCall) -> Self {
            Self::Queue(value)
        }
    }
    impl ::core::convert::From<QuorumCall> for RindexerArbitrumCoreGovernorGenCalls {
        fn from(value: QuorumCall) -> Self {
            Self::Quorum(value)
        }
    }
    impl ::core::convert::From<QuorumDenominatorCall> for RindexerArbitrumCoreGovernorGenCalls {
        fn from(value: QuorumDenominatorCall) -> Self {
            Self::QuorumDenominator(value)
        }
    }
    impl ::core::convert::From<QuorumNumeratorWithBlockNumberCall> for RindexerArbitrumCoreGovernorGenCalls {
        fn from(value: QuorumNumeratorWithBlockNumberCall) -> Self {
            Self::QuorumNumeratorWithBlockNumber(value)
        }
    }
    impl ::core::convert::From<QuorumNumeratorCall> for RindexerArbitrumCoreGovernorGenCalls {
        fn from(value: QuorumNumeratorCall) -> Self {
            Self::QuorumNumerator(value)
        }
    }
    impl ::core::convert::From<RelayCall> for RindexerArbitrumCoreGovernorGenCalls {
        fn from(value: RelayCall) -> Self {
            Self::Relay(value)
        }
    }
    impl ::core::convert::From<RenounceOwnershipCall> for RindexerArbitrumCoreGovernorGenCalls {
        fn from(value: RenounceOwnershipCall) -> Self {
            Self::RenounceOwnership(value)
        }
    }
    impl ::core::convert::From<SetLateQuorumVoteExtensionCall> for RindexerArbitrumCoreGovernorGenCalls {
        fn from(value: SetLateQuorumVoteExtensionCall) -> Self {
            Self::SetLateQuorumVoteExtension(value)
        }
    }
    impl ::core::convert::From<SetProposalThresholdCall> for RindexerArbitrumCoreGovernorGenCalls {
        fn from(value: SetProposalThresholdCall) -> Self {
            Self::SetProposalThreshold(value)
        }
    }
    impl ::core::convert::From<SetVotingDelayCall> for RindexerArbitrumCoreGovernorGenCalls {
        fn from(value: SetVotingDelayCall) -> Self {
            Self::SetVotingDelay(value)
        }
    }
    impl ::core::convert::From<SetVotingPeriodCall> for RindexerArbitrumCoreGovernorGenCalls {
        fn from(value: SetVotingPeriodCall) -> Self {
            Self::SetVotingPeriod(value)
        }
    }
    impl ::core::convert::From<StateCall> for RindexerArbitrumCoreGovernorGenCalls {
        fn from(value: StateCall) -> Self {
            Self::State(value)
        }
    }
    impl ::core::convert::From<SupportsInterfaceCall> for RindexerArbitrumCoreGovernorGenCalls {
        fn from(value: SupportsInterfaceCall) -> Self {
            Self::SupportsInterface(value)
        }
    }
    impl ::core::convert::From<TimelockCall> for RindexerArbitrumCoreGovernorGenCalls {
        fn from(value: TimelockCall) -> Self {
            Self::Timelock(value)
        }
    }
    impl ::core::convert::From<TokenCall> for RindexerArbitrumCoreGovernorGenCalls {
        fn from(value: TokenCall) -> Self {
            Self::Token(value)
        }
    }
    impl ::core::convert::From<TransferOwnershipCall> for RindexerArbitrumCoreGovernorGenCalls {
        fn from(value: TransferOwnershipCall) -> Self {
            Self::TransferOwnership(value)
        }
    }
    impl ::core::convert::From<UpdateQuorumNumeratorCall> for RindexerArbitrumCoreGovernorGenCalls {
        fn from(value: UpdateQuorumNumeratorCall) -> Self {
            Self::UpdateQuorumNumerator(value)
        }
    }
    impl ::core::convert::From<UpdateTimelockCall> for RindexerArbitrumCoreGovernorGenCalls {
        fn from(value: UpdateTimelockCall) -> Self {
            Self::UpdateTimelock(value)
        }
    }
    impl ::core::convert::From<VersionCall> for RindexerArbitrumCoreGovernorGenCalls {
        fn from(value: VersionCall) -> Self {
            Self::Version(value)
        }
    }
    impl ::core::convert::From<VotingDelayCall> for RindexerArbitrumCoreGovernorGenCalls {
        fn from(value: VotingDelayCall) -> Self {
            Self::VotingDelay(value)
        }
    }
    impl ::core::convert::From<VotingPeriodCall> for RindexerArbitrumCoreGovernorGenCalls {
