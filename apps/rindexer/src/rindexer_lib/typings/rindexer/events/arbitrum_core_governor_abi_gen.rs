...
pub mod rindexer_arbitrum_core_governor_gen {
    ...
    pub static RINDEXERARBITRUMCOREGOVERNORGEN_ABI: ::ethers::contract::Lazy<::ethers::core::abi::Abi> = ::ethers::contract::Lazy::new(__abi);
    ...
    impl ::ethers::contract::EthLogDecode for RindexerArbitrumCoreGovernorGenEvents {
        fn decode_log(log: &::ethers::core::abi::RawLog) -> ::core::result::Result<Self, ::ethers::core::abi::Error> {
            if let Ok(decoded) = InitializedFilter::decode_log(log) {
                return Ok(RindexerArbitrumCoreGovernorGenEvents::InitializedFilter(
                    decoded,
                ));
            }
            ...
            if let Ok(decoded) = ProposalQueuedFilter::decode_log(log) {
                return Ok(RindexerArbitrumCoreGovernorGenEvents::ProposalQueuedFilter(
                    decoded,
                ));
            }
            ...
            if let Ok(decoded) = TimelockChangeFilter::decode_log(log) {
                return Ok(RindexerArbitrumCoreGovernorGenEvents::TimelockChangeFilter(
                    decoded,
                ));
            }
            if let Ok(decoded) = VoteCastFilter::decode_log(log) {
                return Ok(RindexerArbitrumCoreGovernorGenEvents::VoteCastFilter(
                    decoded,
                ));
            }
            ...
            if let Ok(decoded) = VotingDelaySetFilter::decode_log(log) {
                return Ok(RindexerArbitrumCoreGovernorGenEvents::VotingDelaySetFilter(
                    decoded,
                ));
            }
