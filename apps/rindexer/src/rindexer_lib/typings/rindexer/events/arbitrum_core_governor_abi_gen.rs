...
pub mod rindexer_arbitrum_core_governor_gen {
    ...
    pub static RINDEXERARBITRUMCOREGOVERNORGEN_ABI: ::ethers::contract::Lazy<
        ::ethers::core::abi::Abi,
    ...
    impl<M: ::ethers::providers::Middleware> RindexerArbitrumCoreGovernorGen<M> {
        ...
        pub fn proposal_extended_filter(
            &self,
        ) -> ::ethers::contract::builders::Event<::std::sync::Arc<M>, M, ProposalExtendedFilter>
        {
            self.0.event()
        }
        ...
        pub fn events(
            ...
            ::std::sync::Arc<M>,
            M,
            RindexerArbitrumCoreGovernorGenEvents,
        > {
            self.0
    ...
    impl<M: ::ethers::providers::Middleware> From<::ethers::contract::Contract<M>>
        for RindexerArbitrumCoreGovernorGen<M>
    {
    ...
    impl ::ethers::contract::EthLogDecode for RindexerArbitrumCoreGovernorGenEvents {
        fn decode_log(
            ...
            if let Ok(decoded) = LateQuorumVoteExtensionSetFilter::decode_log(log) {
                return Ok(
                    RindexerArbitrumCoreGovernorGenEvents::LateQuorumVoteExtensionSetFilter(
                        decoded,
                    ),
                );
            }
            if let Ok(decoded) = OwnershipTransferredFilter::decode_log(log) {
                return Ok(
                    RindexerArbitrumCoreGovernorGenEvents::OwnershipTransferredFilter(decoded),
                );
            }
            ...
            if let Ok(decoded) = ProposalThresholdSetFilter::decode_log(log) {
                return Ok(
                    RindexerArbitrumCoreGovernorGenEvents::ProposalThresholdSetFilter(decoded),
                );
            }
            if let Ok(decoded) = QuorumNumeratorUpdatedFilter::decode_log(log) {
                return Ok(
                    RindexerArbitrumCoreGovernorGenEvents::QuorumNumeratorUpdatedFilter(decoded),
                );
            }
            ...
            if let Ok(decoded) = VoteCastWithParamsFilter::decode_log(log) {
                return Ok(
                    RindexerArbitrumCoreGovernorGenEvents::VoteCastWithParamsFilter(decoded),
                );
            }
    ...
    impl ::core::convert::From<LateQuorumVoteExtensionSetFilter>
        for RindexerArbitrumCoreGovernorGenEvents
    {
    ...
    impl ::ethers::core::abi::AbiDecode for RindexerArbitrumCoreGovernorGenCalls {
        fn decode(
            ...
            if let Ok(decoded) =
                <ExcludeAddressCall as ::ethers::core::abi::AbiDecode>::decode(data)
            {
                return Ok(Self::ExcludeAddress(decoded));
            }
            if let Ok(decoded) =
                <ExtendedBallotTypehashCall as ::ethers::core::abi::AbiDecode>::decode(data)
            {
            ...
            if let Ok(decoded) =
                <CastVoteWithReasonAndParamsCall as ::ethers::core::abi::AbiDecode>::decode(data)
            {
            ...
            if let Ok(decoded) =
                <GetPastCirculatingSupplyCall as ::ethers::core::abi::AbiDecode>::decode(data)
            {
            ...
            if let Ok(decoded) =
                <GetVotesWithParamsCall as ::ethers::core::abi::AbiDecode>::decode(data)
            {
            ...
            if let Ok(decoded) =
                <LateQuorumVoteExtensionCall as ::ethers::core::abi::AbiDecode>::decode(data)
            {
            ...
            if let Ok(decoded) =
                <QuorumNumeratorWithBlockNumberCall as ::ethers::core::abi::AbiDecode>::decode(data)
            {
            ...
            if let Ok(decoded) =
                <SetLateQuorumVoteExtensionCall as ::ethers::core::abi::AbiDecode>::decode(data)
            {
    ...
    impl ::core::convert::From<CastVoteWithReasonAndParamsCall>
        for RindexerArbitrumCoreGovernorGenCalls
    {
