...
use super::arbitrum_sc_nominations_abi_gen::RindexerArbitrumSCNominationsGen::{self, RindexerArbitrumSCNominationsGenEvents, RindexerArbitrumSCNominationsGenInstance};
...
pub async fn arbitrum_sc_nominations_contract(network: &str) -> RindexerArbitrumSCNominationsGenInstance<Arc<RindexerProvider>> {
...
pub async fn decoder_contract(network: &str) -> RindexerArbitrumSCNominationsGenInstance<Arc<RindexerProvider>> {
    if network == "arbitrum" {
        RindexerArbitrumSCNominationsGen::new(
    ...
    TExtensions: 'static + Send + Sync,
{
    ...
    fn decoder(&self, network: &str) -> Arc<dyn Fn(Vec<B256>, Bytes) -> Arc<dyn Any + Send + Sync> + Send + Sync> {
        ...
        match self {
            ArbitrumSCNominationsEventType::ProposalCreated(_) => Arc::new(
            ...
            ArbitrumSCNominationsEventType::ProposalExecuted(_) => Arc::new(
