...
use super::arb_token_abi_gen::RindexerARBTokenGen::{self, RindexerARBTokenGenEvents, RindexerARBTokenGenInstance};
...
pub async fn arb_token_contract(network: &str) -> RindexerARBTokenGenInstance<Arc<RindexerProvider>> {
    ...
    TExtensions: 'static + Send + Sync,
{
    ...
    fn decoder(&self, network: &str) -> Arc<dyn Fn(Vec<B256>, Bytes) -> Arc<dyn Any + Send + Sync> + Send + Sync> {
        ...
        match self {
            ...
            ARBTokenEventType::DelegateVotesChanged(_) => Arc::new(
