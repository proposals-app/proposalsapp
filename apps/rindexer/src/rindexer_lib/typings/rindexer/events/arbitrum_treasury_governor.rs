...
use super::arbitrum_treasury_governor_abi_gen::rindexer_arbitrum_treasury_governor_gen::{
    self, RindexerArbitrumTreasuryGovernorGen,
};
use ethers::{
    abi::Address,
...
pub type LateQuorumVoteExtensionSetData =
    rindexer_arbitrum_treasury_governor_gen::LateQuorumVoteExtensionSetFilter;
...
pub type OwnershipTransferredData =
    rindexer_arbitrum_treasury_governor_gen::OwnershipTransferredFilter;
...
pub type ProposalThresholdSetData =
    rindexer_arbitrum_treasury_governor_gen::ProposalThresholdSetFilter;
...
pub type QuorumNumeratorUpdatedData =
    rindexer_arbitrum_treasury_governor_gen::QuorumNumeratorUpdatedFilter;
...
pub fn arbitrum_treasury_governor_contract(
    network: &str,
) -> RindexerArbitrumTreasuryGovernorGen<Arc<Provider<RetryClient<Http>>>> {
    ...
    TExtensions: 'static + Send + Sync,
{
    pub fn topic_id(&self) -> &'static str {
        match self {
            ArbitrumTreasuryGovernorEventType::Initialized(_) => {
            ...
            ArbitrumTreasuryGovernorEventType::ProposalCanceled(_) => {
            ...
            ArbitrumTreasuryGovernorEventType::ProposalQueued(_) => {
            ...
            ArbitrumTreasuryGovernorEventType::TimelockChange(_) => {
            ...
            ArbitrumTreasuryGovernorEventType::VotingDelaySet(_) => {
                "0xc565b045403dc03c2eea82b81a0465edad9e2e7fc4d97e11421c209da93d7a93"
            }
            ArbitrumTreasuryGovernorEventType::VotingPeriodSet(_) => {
    ...
    fn decoder(
        ...
        match self {
            ...
            ArbitrumTreasuryGovernorEventType::ProposalCreated(_) => Arc::new(
            ...
            ArbitrumTreasuryGovernorEventType::ProposalQueued(_) => Arc::new(
            ...
            ArbitrumTreasuryGovernorEventType::TimelockChange(_) => Arc::new(
            ...
            ArbitrumTreasuryGovernorEventType::VotingDelaySet(_) => Arc::new(
            ...
            ArbitrumTreasuryGovernorEventType::VotingPeriodSet(_) => Arc::new(
