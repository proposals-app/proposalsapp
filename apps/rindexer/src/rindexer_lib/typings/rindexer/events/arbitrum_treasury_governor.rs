...
use super::arbitrum_treasury_governor_abi_gen::RindexerArbitrumTreasuryGovernorGen::{self, RindexerArbitrumTreasuryGovernorGenEvents, RindexerArbitrumTreasuryGovernorGenInstance};
...
pub async fn arbitrum_treasury_governor_contract(network: &str) -> RindexerArbitrumTreasuryGovernorGenInstance<Arc<RindexerProvider>> {
...
pub async fn decoder_contract(network: &str) -> RindexerArbitrumTreasuryGovernorGenInstance<Arc<RindexerProvider>> {
    if network == "arbitrum" {
        RindexerArbitrumTreasuryGovernorGen::new(
    ...
    TExtensions: 'static + Send + Sync,
{
    ...
    fn decoder(&self, network: &str) -> Arc<dyn Fn(Vec<B256>, Bytes) -> Arc<dyn Any + Send + Sync> + Send + Sync> {
        ...
        match self {
            ...
            ArbitrumTreasuryGovernorEventType::ProposalExecuted(_) => Arc::new(
            ...
            ArbitrumTreasuryGovernorEventType::ProposalExtended(_) => Arc::new(
            ...
            ArbitrumTreasuryGovernorEventType::VoteCast(_) => Arc::new(
            ...
            ArbitrumTreasuryGovernorEventType::VoteCastWithParams(_) => Arc::new(
                move |topics: Vec<B256>, data: Bytes| match VoteCastWithParamsData::decode_raw_log(topics, &data[0..]) {
                    Ok(event) => {
