...
use super::super::super::typings::rindexer::events::arbitrum_treasury_governor::{ArbitrumTreasuryGovernorEventType, ProposalCreatedEvent, ProposalExecutedEvent, ProposalExtendedEvent, ProposalQueuedEvent, VoteCastEvent, VoteCastWithParamsEvent, no_extensions};
use crate::{
    extensions::{
