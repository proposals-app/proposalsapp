use super::rindexer::{arb_token::arb_token_handlers, arbitrum_core_governor::arbitrum_core_governor_handlers, arbitrum_sc_nominations::arbitrum_sc_nominations_handlers, arbitrum_treasury_governor::arbitrum_treasury_governor_handlers};
