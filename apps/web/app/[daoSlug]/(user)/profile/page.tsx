  ...
  return (
    <div className='flex h-full w-full flex-col items-center'>
      <div className='flex h-full w-full'>
        <div className='border-neutral-350 dark:border-neutral-650 flex h-full w-full items-center justify-center border-r bg-neutral-100 dark:bg-neutral-900'>
          {!session && <LoginForm />}
              ...
              <main className='h-full w-full overflow-y-auto p-4 pb-16 md:w-3/4 md:px-8 lg:px-16'>
                ...
                <div id='signout' className='justify-self-end'>
                  <form action={signOut}>
                    <button
                      type='submit'
                      className='border-input bg-background hover:bg-accent hover:text-accent-foreground focus:ring-ring inline-flex items-center justify-center border px-6 py-2 text-sm font-medium transition-colors focus:ring-2 focus:ring-offset-2 focus:outline-none disabled:opacity-50'
                    >
