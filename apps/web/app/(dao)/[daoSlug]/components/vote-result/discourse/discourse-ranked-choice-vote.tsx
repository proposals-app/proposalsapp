...
export const DiscourseRankedChoiceVote = ({
  result,
  currentTime,
  width = 1200,
  ...
  const statusText = isLive
    ? `Active Ranked-choice vote`
    : `Ended Ranked-choice vote`;
  ...
  return (
    <div tw='bg-[rgba(239,239,239,0.25)] w-full border border-[#e9e9e9] flex'>
      ...
      >
        {/* First row when narrow: Vote button and Status */}
        {isNarrow && (
        ...
        {/* Right section - Vote button (when not narrow) */}
        {!isNarrow && (
          <div tw='bg-[#12aaff] flex'>
            <div
              tw='flex items-center justify-center'
