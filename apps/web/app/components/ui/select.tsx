...
export const SelectItem = ({ children, value }: SelectItemProps) => {
  ...
  return (
    <div
      ...
      className='relative flex cursor-pointer items-center py-2 pr-10 pl-2 text-sm font-bold text-neutral-800 transition-colors will-change-transform outline-none hover:bg-neutral-100 dark:text-neutral-200 dark:hover:bg-neutral-800'
      onClick={() => {
        onSelectValue(value);
        setIsOpen(false);
      }}
