...
pub fn seed_data() -> Vec<DaoSeedData> {
    vec![
        DaoSeedData {
            ...
            handlers: vec![
                HandlerData {
                    handler_type: DaoHandlerEnum::Snapshot,
                ...
                HandlerData {
                    handler_type: DaoHandlerEnum::AaveV2Mainnet,
                ...
                HandlerData {
                    handler_type: DaoHandlerEnum::AaveV3PolygonPos,
                    governance_portal: "https://app.aave.com/governance".to_string(),
                    decoder: json!({
                ...
                HandlerData {
                    handler_type: DaoHandlerEnum::AaveV3Avalanche,
                    governance_portal: "https://app.aave.com/governance".to_string(),
                    decoder: json!({
        ...
        DaoSeedData {
            ...
            handlers: vec![
                ...
                HandlerData {
                    handler_type: DaoHandlerEnum::DydxMainnet,
        ...
        DaoSeedData {
            ...
            handlers: vec![
                ...
                HandlerData {
                    handler_type: DaoHandlerEnum::EnsMainnet,
        ...
        DaoSeedData {
            ...
            handlers: vec![
                ...
                HandlerData {
                    handler_type: DaoHandlerEnum::GitcoinMainnet,
                ...
                HandlerData {
                    handler_type: DaoHandlerEnum::GitcoinV2Mainnet,
                    governance_portal: "https://www.tally.xyz/gov/gitcoin".to_string(),
        ...
        DaoSeedData {
            ...
            handlers: vec![
                ...
                HandlerData {
                    handler_type: DaoHandlerEnum::HopMainnet,
        ...
        DaoSeedData {
            ...
            handlers: vec![
                ...
                HandlerData {
                    handler_type: DaoHandlerEnum::UniswapMainnet,
        ...
        DaoSeedData {
            ...
            handlers: vec![
                ...
                HandlerData {
                    handler_type: DaoHandlerEnum::OpOptimism,
        ...
        DaoSeedData {
            ...
            handlers: vec![
                ...
                HandlerData {
                    handler_type: DaoHandlerEnum::ArbCoreArbitrum,
                ...
                HandlerData {
                    handler_type: DaoHandlerEnum::ArbTreasuryArbitrum,
                    governance_portal: "https://www.tally.xyz/gov/arbitrum".to_string(),
        ...
        DaoSeedData {
            ...
            handlers: vec![
                ...
                HandlerData {
                    handler_type: DaoHandlerEnum::FraxAlphaMainnet,
                ...
                HandlerData {
                    handler_type: DaoHandlerEnum::FraxOmegaMainnet,
                    governance_portal: "https://app.frax.finance/gov/frax".to_string(),
        ...
        DaoSeedData {
            ...
            handlers: vec![HandlerData {
                handler_type: DaoHandlerEnum::NounsProposalsMainnet,
        ...
        DaoSeedData {
            ...
            handlers: vec![
                HandlerData {
                    handler_type: DaoHandlerEnum::MakerExecutiveMainnet,
                ...
                HandlerData {
                    handler_type: DaoHandlerEnum::MakerPollMainnet,
                ...
                HandlerData {
                    handler_type: DaoHandlerEnum::MakerPollArbitrum,
                    governance_portal: "https://vote.makerdao.com/polling/".to_string(),
        ...
        //     slug: "interest_protocol".to_string().into(),
        //     hot: 0,
        //     settings: SettingsData {
        ...
        //     slug: "0x_protocol".to_string().into(),
        //     hot: 0,
        //     settings: SettingsData {
        ...
        //     slug: "index_coop".to_string().into(),
        //     hot: 0,
        //     settings: SettingsData {
        ...
        //     slug: "aura_finance".to_string().into(),
        //     hot: 0,
        //     settings: SettingsData {
        ...
        //     slug: "developer_dao".to_string().into(),
        //     hot: 0,
        //     settings: SettingsData {
        ...
        //     slug: "solace_dao".to_string().into(),
        //     hot: 0,
        //     settings: SettingsData {
        ...
        //     slug: "rocket_pool".to_string().into(),
        //     hot: 0,
        //     settings: SettingsData {
