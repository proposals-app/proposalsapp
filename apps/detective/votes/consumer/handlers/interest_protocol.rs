...
use contracts::gen::interest_protocol_gov::interest_protocol_gov::interest_protocol_gov;
use contracts::gen::interest_protocol_gov::VoteCastFilter;
...
pub async fn interest_protocol_votes(dao_handler: &dao_handler::Model) -> Result<ChainVotesResult> {
    ...
    let gov_contract = interest_protocol_gov::new(address, eth_rpc);
