...
use contracts::gen::compound_gov::VoteCastFilter;
...
pub async fn compound_votes(dao_handler: &dao_handler::Model) -> Result<ChainVotesResult> {
    ...
    let gov_contract = compound_gov::new(address, eth_rpc);
