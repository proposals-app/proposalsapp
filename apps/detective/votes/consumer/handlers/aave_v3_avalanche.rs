...
use contracts::gen::aave_v_3_voting_machine_avalanche::aave_v3_voting_machine_avalanche;
use contracts::gen::aave_v_3_voting_machine_avalanche::VoteEmittedFilter;
