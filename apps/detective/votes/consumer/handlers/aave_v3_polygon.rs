...
use contracts::gen::aave_v_3_voting_machine_polygon::aave_v3_voting_machine_polygon;
use contracts::gen::aave_v_3_voting_machine_polygon::VoteEmittedFilter;
...
pub async fn aave_v3_polygon_votes(dao_handler: &dao_handler::Model) -> Result<ChainVotesResult> {
    ...
    let gov_contract = aave_v3_voting_machine_polygon::new(address, poly_rpc);
