...
use contracts::gen::zerox_treasury::VoteCastFilter;
...
pub async fn zerox_treasury_votes(dao_handler: &dao_handler::Model) -> Result<ChainVotesResult> {
    ...
    let gov_contract = zerox_treasury::new(address, eth_rpc);
