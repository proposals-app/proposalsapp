...
pub struct ArbitrumCouncilMembersProposalsIndexer;

#[async_trait]
impl Indexer for ArbitrumCouncilMembersProposalsIndexer {
...
#[async_trait]
impl ProposalsIndexer for ArbitrumCouncilMembersProposalsIndexer {
