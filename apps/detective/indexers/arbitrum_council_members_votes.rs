...
pub struct ArbitrumCouncilMembersVotesIndexer;

impl ArbitrumCouncilMembersVotesIndexer {
...
#[async_trait]
impl Indexer for ArbitrumCouncilMembersVotesIndexer {
...
#[async_trait]
impl VotesIndexer for ArbitrumCouncilMembersVotesIndexer {
