...
use contracts::gen::ens_gov::ens_gov::ens_gov;
use contracts::gen::ens_gov::ProposalCreatedFilter;
use ethers::prelude::*;
...
pub async fn ens_proposals(dao_handler: &dao_handler::Model) -> Result<ChainProposalsResult> {
