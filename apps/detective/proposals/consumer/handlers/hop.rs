...
use contracts::gen::hop_gov::{hop_gov::hop_gov, ProposalCreatedFilter};
use ethers::prelude::*;
...
#[async_trait]
impl ProposalHandler for HopHandler {
    ...
    async fn get_proposals(
        ...
        info!("Fetching proposals for HopHandler");
        ...
        let address = "0xed8Bdb5895B8B7f9Fdb3C087628FD8410E853D48"
            .parse::<Address>()
            .context("bad address")?;
...
async fn data_for_proposal(
    p: (contracts::gen::hop_gov::ProposalCreatedFilter, LogMeta),
    rpc: &Arc<Provider<Http>>,
    dao_handler: &dao_handler::Model,
    gov_contract: hop_gov<ethers::providers::Provider<ethers::providers::Http>>,
    ...
    let proposal_url = format!("https://www.tally.xyz/gov/hop/proposal/{}", log.proposal_id);
    ...
    let proposal_votes = gov_contract
        ...
        .call()
        .await
        .context("gob_contract.proposal_votes")?;
