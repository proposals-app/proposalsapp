...
use contracts::gen::hop_gov::hop_gov::hop_gov;
use contracts::gen::hop_gov::ProposalCreatedFilter;
use ethers::prelude::*;
...
pub async fn hop_proposals(dao_handler: &dao_handler::Model) -> Result<ChainProposalsResult> {
