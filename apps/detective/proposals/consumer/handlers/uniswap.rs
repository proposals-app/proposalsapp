...
use contracts::gen::uniswap_gov::{uniswap_gov::uniswap_gov, ProposalCreatedFilter};
use ethers::prelude::*;
...
#[async_trait]
impl ProposalHandler for UniswapHandler {
    ...
    async fn get_proposals(
        ...
        info!("Fetching proposals for UniswapHandler");
...
async fn data_for_proposal(
    p: (contracts::gen::uniswap_gov::ProposalCreatedFilter, LogMeta),
    rpc: &Arc<Provider<Http>>,
    dao_handler: &dao_handler::Model,
    gov_contract: uniswap_gov<ethers::providers::Provider<ethers::providers::Http>>,
    ...
    let proposal_url = format!("https://app.uniswap.org/#/vote/2/{}", log.id);
