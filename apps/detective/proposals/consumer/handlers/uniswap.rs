...
use contracts::gen::uniswap_gov::uniswap_gov::uniswap_gov;
use contracts::gen::uniswap_gov::ProposalCreatedFilter;
use ethers::prelude::*;
...
pub async fn uniswap_proposals(dao_handler: &dao_handler::Model) -> Result<ChainProposalsResult> {
