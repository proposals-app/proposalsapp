export function buildProposalSystemPrompt(params: {
  ...
  return [
    ...
    '- after 5 focused reads, decline if you still do not have a concrete same-DAO target group UUID',
    ...
    '',
    `The harness will start nudging you to wrap up around ${params.maxQueryCalls} query_proposal_mapping_data calls or ${Math.round(params.timeoutMs / 60_000)} minutes of search time.`,
